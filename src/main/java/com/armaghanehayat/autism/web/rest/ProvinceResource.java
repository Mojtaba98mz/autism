...
import com.armaghanehayat.autism.service.ProvinceQueryService;
...
/**
 * REST controller for managing {@link com.armaghanehayat.autism.domain.Province}.
 */
@RestController
@RequestMapping("/api")
public class ProvinceResource {
    ...
    public ResponseEntity<List<Province>> getAllProvinces(ProvinceCriteria criteria, Pageable pageable) {
