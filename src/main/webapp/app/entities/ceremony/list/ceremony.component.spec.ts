...
describe('Component Tests', () => {
  describe('Ceremony Management Component', () => {
    let comp: CeremonyComponent;
    ...
    beforeEach(() => {
      TestBed.configureTestingModule({
        ...
        .overrideTemplate(CeremonyComponent, '')
        .compileComponents();
    ...
    it('Should call load all on init', () => {
      ...
      expect(comp.ceremonies?.[0]).toEqual(expect.objectContaining({ id: 123 }));
    });
